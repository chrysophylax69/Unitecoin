...
static const int64 DUST_SOFT_LIMIT = 10000000; // 0.1 UNI
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000000;   // 0.01 UNI mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 100000000 * COIN; // set to 100mil UNI //TEMPLATE
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 720 / 250;  //TEMPLATE
    }
